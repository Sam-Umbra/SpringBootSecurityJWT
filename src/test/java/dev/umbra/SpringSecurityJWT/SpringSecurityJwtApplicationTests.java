package dev.umbra.SpringSecurityJWT;
...
class SpringSecurityJwtApplicationTests {
    ...
    public void criptogaSenha() {
        /**
         * MÃ©todo para criptografar senha formato RAW para BCrypt
         * Neste exemplo utiliza-se senha123 para inicializar os usuÃ¡rios
         * na base H2 para testes
         * 
         * VocÃª deve manualmente pegar essa senha criptografada e
         * adicionar na base.s
         */
